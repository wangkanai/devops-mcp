...
- **Compiled Server**: `/Users/wangkanai/Sources/azure-devops-mcp-proxy/dist/index.js` exists and is executable
...
Server Info: azure-devops-mcp-proxy v1.0.0
...
- **Configuration File**: Created `/Users/wangkanai/Sources/azure-devops-mcp-proxy/config/claude-code-servers.json`
...
1. **Copy Configuration File**:
   ```bash
   cp /Users/wangkanai/Sources/azure-devops-mcp-proxy/config/claude-code-servers.json ~/.config/claude-code/servers.json
   ```

2. **Restart Claude Code**: The azure-devops-mcp-proxy server will be automatically available
...
1. **Start Server**:
   ```bash
   cd /Users/wangkanai/Sources/azure-devops-mcp-proxy
   npm start
   ```
